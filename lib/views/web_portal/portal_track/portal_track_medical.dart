...
class PortalTrackMedicalState extends StatefulWidget {
  const PortalTrackMedicalState({Key? key}) : super(key: key);
  
  @override
  _PortalTrackMedicalState createState() => _PortalTrackMedicalState();
}

class _PortalTrackMedicalState extends State<PortalTrackMedicalState> {
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              ...
              _itemDetails(label: utils.getTranslated('patientName', context), details: 'Ali Bin Ahmad', hasMultiInfo: false),
              _itemDetails(label: utils.getTranslated('patientMyKadNo', context), details: '560518148956', hasMultiInfo: false),
              _itemDetails(label: utils.getTranslated('totalApproved', context), details: 'RM1,000', hasMultiInfo: false),
              Stack(
                children: <Widget>[
                  Container(
                    // elevation: 4.0,
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text(
                  'Permohonan Tuntutan Perubatan Veteran',
