...
import 'package:myveteran/views/home/panel_service/bmj/bmj_track/bmj_track.dart';
...
class BmjState extends StatefulWidget {
  final int? selectedTab;

  const BmjState({Key? key, @required this.selectedTab}) : super(key: key);
  
  @override
  _BmjState createState() => _BmjState();
}

class _BmjState extends State<BmjState> with SingleTickerProviderStateMixin {
              ...
              SliverFillRemaining(
                child: TabBarView(
                  ...
                  children: <Widget>[
                    ...
                    PortalBrowseState(pageName: utils.getTranslated('bmj', context)),
                    const BmjTrackState()
                  ]
                )
              ),
