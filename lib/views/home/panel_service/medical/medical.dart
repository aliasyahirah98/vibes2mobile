...
import 'package:myveteran/views/home/panel_service/medical/medical_track/medical_track.dart';
...
class MedicalState extends StatefulWidget {
  final int? selectedTab;

  const MedicalState({Key? key, @required this.selectedTab}) : super(key: key);
  
  @override
  _MedicalState createState() => _MedicalState();
}

class _MedicalState extends State<MedicalState> with SingleTickerProviderStateMixin {
              ...
              SliverFillRemaining(
                child: TabBarView(
                  ...
                  children: <Widget>[
                    ...
                    PortalBrowseState(pageName: utils.getTranslated('medical', context)),
                    const MedicalTrackState()
                  ]
                )
              ),
            ]
