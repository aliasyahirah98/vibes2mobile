...
import 'package:myveteran/views/home/panel_service/welfare/welfare_track/welfare_track.dart';
...
class WelfareState extends StatefulWidget {
  final int? selectedTab;

  const WelfareState({Key? key, @required this.selectedTab}) : super(key: key);
  
  @override
  _WelfareState createState() => _WelfareState();
}

class _WelfareState extends State<WelfareState> with SingleTickerProviderStateMixin {
              ...
              SliverFillRemaining(
                child: TabBarView(
                  ...
                  children: <Widget>[
                    ...
                    PortalBrowseState(pageName: utils.getTranslated('welfare', context)),
                    const WelfareTrackState()
                  ]
                )
              ),
            ]
