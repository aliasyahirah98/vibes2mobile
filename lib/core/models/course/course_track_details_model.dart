class CourseTrackDetailsModel {
  ...
  static listFromJson(List<dynamic> listJson) {
    List<CourseTrackDetailsModel> data = [];
    for (var value in listJson) {
      data.add(CourseTrackDetailsModel.fromJson(value));
    }
    return data;
  }

  factory CourseTrackDetailsModel.fromJson(Map<String, dynamic> objJson) {
    return CourseTrackDetailsModel(
      id: objJson['Id'] ?? 0,
