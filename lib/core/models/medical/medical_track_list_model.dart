class MedicalTrackListModel {
  List<MedicalTrackInfoModel>? medicalTrackList;
  int? returnCode;
  String? responseMessage;

  MedicalTrackListModel(
    {
      this.medicalTrackList,
      this.returnCode,
      this.responseMessage
    }
  );

  factory MedicalTrackListModel.fromJson(Map<String, dynamic> objJson) {
    return MedicalTrackListModel(
      medicalTrackList: objJson['list'] != null ? MedicalTrackInfoModel.listFromJson(objJson['list']) : [],
...
class MedicalTrackInfoModel {
  ...
  static listFromJson(List<dynamic> listJson) {
    List<MedicalTrackInfoModel> data = [];
    for (var value in listJson) {
      data.add(MedicalTrackInfoModel.fromJson(value));
    }
    return data;
  }

  factory MedicalTrackInfoModel.fromJson(Map<String, dynamic> objJson) {
    return MedicalTrackInfoModel(
...
class MedicalResponseModel {
  ...
  factory MedicalResponseModel.fromJson(Map<String, dynamic> objJson) {
